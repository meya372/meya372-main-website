...
<link rel="stylesheet" href="admin_css/edit_service_table.css">
    ...
    <div class="bottom-container">
        ...
        <div class="dashboard">
            ...
            <div class="flex flex-col items-start">
                ...
                <p class="text-gray-400">Edit existing services on the Meya store</p>
                <hr class="my-2">
            </div>
                                ...
                                <div class="table100">
                                    <table>
                                        <thead>
                                            <tr class="table100-head">
                                                ...
                                                <th class="column3">Service Description</th>
                                        ...
                                        <tbody>
                                            ...
                                            <?php while ($row = $result->fetch_assoc()) : ?>
                                                <tr>
                                                    ...
                                                    <td><?php echo substr($row['discription'], 0, 60) ?></td>
                                                    <td><img src="<?php $row['img_url'] ?>" alt=""></td>
                                                    <td class="flex gap-3 items-center">
                                                        <a href="edit_service_byid.php?id=<?php echo $row['id'] ?>" class="btn btn-edit text-center">
                                                        ...
                                                        <button class="btn btn-delete"><a href="admin_scripts/delete_service.php?id=<?php echo $row['id'] ?>">Delete</a></button>
                                                    </td>
                                                </tr>
                                            <?php endwhile; ?>
                                        </tbody>
                                    ...
                                    <div class="my-5">
                                        <?php if (ceil($total_pages / $num_results_on_page) > 0) : ?>
                                            <ul class="pagination">
                                                <?php if ($page > 1) : ?>
                                                    <li class="prev"><a href="edit_services.php?page=<?php echo $page - 1 ?>">Prev</a></li>
                                                <?php endif; ?>

                                                <?php if ($page > 3) : ?>
                                                    <li class="start"><a href="edit_services.php?page=1">1</a></li>
                                                    <li class="dots">...</li>
                                                <?php endif; ?>

                                                <?php if ($page - 2 > 0) : ?><li class="page"><a href="edit_services.php?page=<?php echo $page - 2 ?>"><?php echo $page - 2 ?></a></li><?php endif; ?>
                                                <?php if ($page - 1 > 0) : ?><li class="page"><a href="edit_services.php?page=<?php echo $page - 1 ?>"><?php echo $page - 1 ?></a></li><?php endif; ?>

                                                <li class="currentpage"><a href="edit_services.php?page=<?php echo $page ?>"><?php echo $page ?></a></li>

                                                <?php if ($page + 1 < ceil($total_pages / $num_results_on_page) + 1) : ?><li class="page"><a href="edit_services.php?page=<?php echo $page + 1 ?>"><?php echo $page + 1 ?></a></li><?php endif; ?>
                                                <?php if ($page + 2 < ceil($total_pages / $num_results_on_page) + 1) : ?><li class="page"><a href="edit_services.php?page=<?php echo $page + 2 ?>"><?php echo $page + 2 ?></a></li><?php endif; ?>

                                                <?php if ($page < ceil($total_pages / $num_results_on_page) - 2) : ?>
                                                    <li class="dots">...</li>
                                                    <li class="end"><a href="edit_services.php?page=<?php echo ceil($total_pages / $num_results_on_page) ?>"><?php echo ceil($total_pages / $num_results_on_page) ?></a></li>
                                                <?php endif; ?>

                                                <?php if ($page < ceil($total_pages / $num_results_on_page)) : ?>
                                                    <li class="next"><a href="edit_services.php?page=<?php echo $page + 1 ?>">Next</a></li>
                                                <?php endif; ?>
                                            </ul>
                                        <?php endif; ?>
                                    </div>
